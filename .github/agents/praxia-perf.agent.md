...
1. List every proposed fix as a numbered item grouped by platform and category.
2. For each: file(s) touched, what changes, expected performance gain, and risk.
